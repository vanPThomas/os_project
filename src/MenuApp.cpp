...
void MenuApp::printUptime()
{
    ...
    uint64_t last_update = HardwareUtil::get_current_us();
    while (true)
    {
        // Update every 5 seconds
        now = HardwareUtil::get_current_us();
...
void MenuApp::okButtonPress()
{
    ...
    HardwareUtil::my_sleep_ms(1500);              // show for 1.5 sec
